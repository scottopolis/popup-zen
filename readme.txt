...
Popups and email opt-ins for people who hate popups.

== Description ==

Popup Zen is a popup and banner plugin for people who sell stuff online with WooCommerce or Easy Digital Downloads.

It’s lightweight and easy to use, unlike other complex popup building tools.

Popup Zen is trusted by some of the best brands in WordPress, like Memberpress, SearchWP, Slocum Studio, Pixel Jar, and more.
...
- <a href="https://hollerwp.com/downloads/sale-notification-popup/" target="_blank">Sale notification popups</a> (Scott just bought Popup Zen Pro)
- Content upgrades
- More popup designs
...
Visit the Popup Zen menu item, and add a new box. Give it a title (not displayed on the front end), and add your content.
...
- ConvertKit: visit Popup Zen => Settings, enter <a href="https://app.convertkit.com/account/edit" target="_blank">your API key</a>. Choose ConvertKit when creating your new Popup Zen, then enter your form ID. Find your form ID by visiting your signup form, then copy the numbers in the url (or in the embed code).
...
Install MailPoet, version 3 or later. Create a new Popup Zen, and select MailPoet as the email provider. Choose your list and save, new subscribers will be added to this list.
...
This is a major update, everything is backwards compatible but you may need to re-save some settings if you make any changes to your Popup Zenes.

* Lightbox popups with templates!
* Popup Zen types: notification box, popup, FOMO, chat, and more
...
* Popup Zen Types: support for new popup and FOMO types
...
* Support for MailChimp groups in Popup Zen Pro
...
* BREAKING CHANGE: If using MailChimp, please visit Popup Zen => Settings and add a MailChimp API key. Next, visit your Popup Zen and change your MailChimp list URL to your list ID, then save.
